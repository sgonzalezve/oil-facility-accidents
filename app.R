...
ui <- bslib::page_fluid(
  ...
  bslib::card(title = "Select a segment of data to view",
                    class ="bg-secondary",
  ...
  bslib::layout_columns(bslib::card(card_header("Conversions over time"),
                      plotOutput("line")),
                      bslib::card(card_header("Conversion rates"),
                      plotOutput("bar")),
                 ...
                 value_box(title = "Avg Spend",
                           ...
                           theme_color = "secondary"),
                 bslib::card(card_header("Conversion rates by subgroup"),
                      tableOutput("table")),
